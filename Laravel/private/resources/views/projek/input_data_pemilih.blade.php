                ...
                <div class="modal-body">
                  <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="nik" type="text" class="form-control" id="nik" required="text">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="tanggal" type="text" class="form-control" id="tanggal" required="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputAlamat" class="col-sm-3 col-form-label">Alamat*</label>
                        <div class="col-sm-8">
                            <input name="alamat" type="text" class="form-control" id="alamat" required="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputJenis_kelamin" class="col-sm-3 col-form-label">Jenis Kelamin*</label>
                        <div class="col-sm-8">
                            <input name="jenisKelamin" type="text" class="form-control" id="inputJenis_kelamin" required="text">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputStatus" class="col-sm-3 col-form-label">Status*</label>
                        <div class="col-sm-8">
                            <input name="status" type="text" class="form-control" id="inputStatus" required="text">
                        </div>
                    </div>
                </div>
